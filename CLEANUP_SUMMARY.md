...
**Date:** 2025-11-17  
**Action:** Moved all non-Fieson content to `/archive` folder
...
- Archive-only: about-hero.tsx, about-mission.tsx, our-values.tsx, why-fieson.tsx, blog-posts.tsx
...
## ✅ What Remains in Main Repo (Clean Fieson Foundation)

### Live Routes
- `src/app/page.tsx` - Main landing page
- `src/app/blog/` - Blog listing (needs new content)
- `src/app/demo/` - Cal.com booking
- `src/app/pricing/` - Fieson pricing
- `src/app/contact/` - Contact form
- `src/app/comparison/` - Fieson vs alternatives

### Live Components (Fieson AI PDP Content)
**Sections (3 files):**
- cta.tsx
- how-it-works.tsx
- who-its-for.tsx
...
**Fix Options:**
- Create new Fieson AI PDP blog posts
...
The main repository now contains **ONLY Fieson AI PDP content** with:
