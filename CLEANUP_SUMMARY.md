...
**Date:** 2025-11-17  
**Action:** Moved all non-Fisca content to `/archive` folder
...
- Archive-only: about-hero.tsx, about-mission.tsx, our-values.tsx, why-Fisca.tsx, blog-posts.tsx
...
## ✅ What Remains in Main Repo (Clean Fisca Foundation)
...
- `src/app/pricing/` - Fisca pricing
- `src/app/contact/` - Contact form
- `src/app/comparison/` - Fisca vs alternatives

### Live Components (Fisca AI PDP Content)
...
- Create new Fisca AI PDP blog posts
...
The main repository now contains **ONLY Fisca AI PDP content** with:
