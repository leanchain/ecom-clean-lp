...
const ImprovedHero = () => {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    if (!email) return;
    setSaved(true);
    console.log("Captured email (demo):", email);
    setTimeout(() => setSaved(false), 4000);
    setEmail("");
  }

  const media = [
    // Different product images from gallery
    {
    ...
    // Features images
    {
      src: "/images/features/ai-image-gen.jpg",
      width: 800,
      height: 600,
    },
    {
      src: "/images/features/ai-search-opt.jpg",
      width: 800,
      height: 600,
    },
    {
    ...
    {
      src: "/images/features/content-enrichment.jpg",
      width: 800,
      height: 600,
    },
  ] as const;
    ...
    <section className="pt-20">
      <div className="container flex flex-col items-center justify-center gap-4 text-center">
        ...
        <div className="mb-12 mt-8">
          <form className="flex flex-col gap-4 max-w-md" onSubmit={handleSubmit} aria-label="Get early access">
            ...
            <div className="flex gap-2">
              ...
              <button
                type="submit"
                className="rounded-full bg-primary px-6 py-2.5 text-sm font-medium text-primary-foreground transition-colors hover:bg-primary/90 flex items-center gap-2"
              >
      ...
      {/* PDP preview showing images and copy together (temporarily hidden) */}
      {false && (
        <div className="container mt-16 grid items-center gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
          <div className="space-y-4 text-left">
            ...
            <h2 className="font-heading text-foreground text-3xl md:text-4xl">
              See images & copy working together on your PDP
            </h2>
            <p className="text-muted-foreground/80 max-w-xl text-sm md:text-base">
              Beseam generates on-brand product images and AI-written
              descriptions that slot straight into your product detail page.
            </p>
            ...
            <div className="relative mx-auto flex h-[420px] w-full max-w-3xl flex-col rounded-[2.5rem] border border-border bg-background shadow-2xl md:h-[520px]">
              ...
              >
                ...
                <div className="mt-4 space-y-3 text-[11px]">
                  ...
                  <ul className="mt-3 space-y-1.5 text-[10px] text-muted-foreground">
                    <li className="flex gap-2">
                      ...
                      <span>
                        AI-crafted images and copy for this SKU.
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-500" />
                  ...
                  <div className="mt-4 space-y-2">
                    <div className="flex items-center justify-between text-[11px] text-muted-foreground">
                      ...
                      <span className="text-emerald-500">AI by Beseam</span>
                    </div>
                    <button
                      type="button"
                    ...
                    <div className="flex items-start gap-2 rounded-2xl bg-muted/60 p-3">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-muted-foreground">
                          Packshot, lifestyle, detail crops and PDP hero images.
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-2 rounded-2xl bg-muted/60 p-3">
                ...
                <div className="mt-6 rounded-2xl bg-muted/60 p-3 text-[10px]">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <p className="text-muted-foreground">
                        Generates on-brand images and narrative blocks.
                      </p>
                    </div>
                    <div className="flex gap-2">
                      <span className="mt-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-background text-[9px] font-semibold">
                ...
                <div className="mt-3 space-y-1 rounded-2xl border bg-muted/40 p-3 text-[10px]">
                  ...
                  <p className="text-muted-foreground">
                    Everything Beseam recommends for AI-ready PDPs: visuals,
                ...
                <div className="mt-3 space-y-2 rounded-2xl border bg-muted/40 p-3 text-[10px]">
                  ...
                  <p className="text-muted-foreground">
                    High-level view of Beseam PDP AI vs traditional PDPs for
                    Aurora:
                  </p>
                ...
                <div className="mt-3 mb-4 space-y-1 rounded-2xl border bg-muted/40 p-3 text-[10px]">
                  ...
                  <p className="text-muted-foreground">
                    Yes. Beseam learns your brand book and collection rules so
