    ...
    <section className="pt-20">
      <div className="container flex flex-col items-center justify-center gap-4 text-center">
        <h1 className="font-heading text-foreground max-w-3xl text-4xl md:text-5xl">
          Instantly Boost Your Sales with High-Converting Product Pages that get
          Recommended by
          <br />{" "}
      ...
      {/* PDP preview showing images, video and copy together */}
      <div className="container mt-16 grid items-center gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)]">
        <div className="space-y-4 text-left">
          ...
          <p className="text-muted-foreground/80 max-w-xl text-sm md:text-base">
            ...
            AI-written descriptions that slot straight into your product detail
            page.
          </p>
        ...
        <div className="relative mx-auto w-full max-w-xs sm:max-w-sm">
          {/* Glow behind phone */}
          <div className="absolute -inset-6 -z-10 rounded-3xl bg-linear-to-br from-primary/25 via-primary/0 to-violet-500/30 blur-2xl" />

          {/* iPhone frame */}
          <div className="relative mx-auto flex h-[500px] w-[260px] flex-col rounded-4xl border border-border bg-background shadow-2xl sm:h-[540px] sm:w-[280px]">
            {/* Notch / dynamic island */}
            <div className="flex items-center justify-center pt-3">
              <div className="h-1.5 w-16 rounded-full bg-muted-foreground/40" />
            </div>

            {/* Scrollable Shopify-style PDP inside phone */}
            <div
              ref={phoneScrollRef}
            ...
            >
              ...
              <div className="mt-4 space-y-3 text-[11px]">
                ...
                <ul className="mt-3 space-y-1.5 text-[10px] text-muted-foreground">
                  <li className="flex gap-2">
                    ...
                    <span>AI-crafted images, video and copy for this SKU.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="mt-1 h-1.5 w-1.5 rounded-full bg-emerald-500" />
                    <span>
                ...
                <div className="mt-3 grid gap-2">
                  <div className="flex items-start gap-2 rounded-2xl bg-muted/60 p-3">
                    ...
                    <div className="space-y-1">
                      <p className="text-foreground font-medium">Visual set</p>
                  ...
                  <div className="flex items-start gap-2 rounded-2xl bg-muted/60 p-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground">
                        Schema, sections and attributes aligned with AI engines.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-6 rounded-2xl bg-muted/60 p-3 text-[10px]">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <p className="text-muted-foreground">
                      Generates on-brand images, PDP video and narrative blocks.
                    </p>
                  </div>
                  <div className="flex gap-2">
                    <span className="mt-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-background text-[9px] font-semibold">
              ...
              <div className="mt-3 space-y-1 rounded-2xl border bg-muted/40 p-3 text-[10px]">
                ...
                <p className="text-muted-foreground">
                  Everything Fieson recommends for AI-ready PDPs: visuals, deep
