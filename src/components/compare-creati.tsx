...
const CompareCreati = () => {
  return (
    <section id="compare-creati" className="py-24">
      <div className="container">
        <div className="text-center">
          <h2 className="mb-4 text-3xl font-bold md:text-5xl">
            Beseam vs Creati.studio: The Clear Winner for AI-Powered PDPs
          </h2>
          <p className="text-muted-foreground mx-auto max-w-2xl text-sm md:text-base">
            While Creati.studio offers basic AI tools, Beseam delivers comprehensive
          ...
          <div className="grid items-start gap-8 lg:grid-cols-2">
            ...
            <div className="bg-muted/70 rounded-3xl p-6 md:p-8">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold md:text-2xl">Creati.studio</h3>
              </div>
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground text-sm">
            Ready to leave Creati.studio behind? Join the brands choosing Beseam for superior AI-powered PDPs.
          </p>
        </div>
      </div>
    </section>
