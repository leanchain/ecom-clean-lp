...
const productshotsFeatures = [
  "Limited product shot variations",
  "Generic AI image generation",
  "Manual editing required",
  "Basic background removal",
  "Higher costs per image",
...
const CompareProductshots = () => {
  return (
    <section id="compare-productshots" className="py-24">
      <div className="container">
        <div className="text-center">
          <h2 className="mb-4 text-3xl font-bold md:text-5xl">
            Beseam vs Productshots.ai: The Clear Winner for AI-Powered PDPs
          </h2>
          <p className="text-muted-foreground mx-auto max-w-2xl text-sm md:text-base">
            While Productshots.ai focuses on basic image generation, Beseam delivers comprehensive
          ...
          <div className="grid items-start gap-8 lg:grid-cols-2">
            ...
            <div className="bg-muted/70 rounded-3xl p-6 md:p-8">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-semibold md:text-2xl">Productshots.ai</h3>
              </div>
              <p className="text-muted-foreground mt-3 text-sm">
                Basic AI image tools with limited depth and scalability for modern
                e-commerce needs.
              </p>

              <ul className="mt-6 space-y-3 text-sm md:text-base">
                {productshotsFeatures.map((item, idx) => (
        ...
        <div className="mt-16 text-center">
          <p className="text-muted-foreground text-sm">
            Ready to leave Productshots.ai behind? Join the brands choosing Beseam for superior AI-powered PDPs.
          </p>
        </div>
      </div>
    </section>
