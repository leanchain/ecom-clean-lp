  ...
  return (
    <div
      className={cn(
        ...
        layout === 'split' && 'md:flex-row md:items-end md:justify-between md:gap-8',
    ...
    >
      ...
      {layout === 'split' && (description || action) && (
        <div className="flex flex-col gap-4 md:items-end md:text-end flex-1">
          {description && (
            <p className={cn('text-lg md:text-xl text-pretty', styles.description)}>
              {description}
            </p>
          )}
