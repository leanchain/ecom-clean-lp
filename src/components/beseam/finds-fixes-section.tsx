...
function CrawlMockup() {
  const rows = [
    ...
    },
    {
      ...
      type: "product",
      status: "Crawling",
      statusClass: "bg-violet-500/10 text-violet-600",
      updated: "running",
    },
    {
    ...
    <div className="space-y-3">
      ...
      <div className="space-y-2">
        {rows.map((row) => (
          <div
            key={row.url}
            className="grid grid-cols-[1.7fr_0.6fr_0.8fr] gap-3 rounded-xl border border-border/40 bg-background/80 px-3 py-2.5"
          >
