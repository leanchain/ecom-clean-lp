      ...
      <div className="mx-auto grid max-w-[92rem] gap-12 px-5 py-20 sm:px-8 sm:py-24 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:gap-20 lg:px-10 lg:py-28">
        ...
        <div className="border-t border-black/25">
          {STORE_HEALTH_FAQS.map((faq) => (
            ...
            >
              <summary className="flex min-h-16 cursor-pointer list-none items-center justify-between gap-5 py-5 text-[16px] font-semibold text-[#111318] marker:content-none focus-visible:ring-2 focus-visible:ring-[#c04e26]">
                <span>{faq.question}</span>
                <span
                  aria-hidden
                  className="font-mono text-[22px] font-normal text-[#c04e26] transition-transform group-open:rotate-45"
                >
                  +
                </span>
              </summary>
              <p className="max-w-3xl pb-6 pr-10 text-[15px] leading-relaxed text-black/62">
                {faq.answer}
              </p>
            </details>
          ))}
