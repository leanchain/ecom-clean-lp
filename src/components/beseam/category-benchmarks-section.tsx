        ...
        <Reveal>
          <div className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-16">
            <div>
              ...
              <h2 className="mt-6 max-w-[20ch] text-balance font-display text-[clamp(2.2rem,3.6vw,3.6rem)] font-normal leading-[1.04] tracking-[-0.02em] text-[#111318]">
              ...
              <p className="mt-6 max-w-[52ch] text-[16px] leading-[1.7] text-black/64">
                {BENCHMARK_RUN.questions} shopper questions asked across{" "}
              ...
              <Link
                href="/benchmarks"
                className="mt-7 inline-flex min-h-11 items-center gap-2 text-[14px] font-semibold text-[#111318] underline decoration-black/25 underline-offset-6 hover:decoration-[#b8441d]"
              >
            ...
            {/* A ledger, not a list: one row per question, the share carried by
                ...
                read one at a time. */}
            <div>
              <div className="hidden grid-cols-[10.5rem_minmax(0,1fr)_9rem] gap-x-6 border-b-2 border-[#111318] pb-2.5 font-mono text-[11px] font-semibold uppercase tracking-[0.1em] text-black/54 xl:grid">
                <span>Category</span>
              ...
              <ul className="border-t-2 border-[#111318] xl:border-t-0">
                {HIGHLIGHTS.map((benchmark) => (
                  <li key={benchmark.slug} className="border-b border-black/16">
                    ...
                    >
                      <span className="col-span-2 font-mono text-[11px] font-semibold uppercase tracking-[0.1em] text-[#b8441d] xl:col-span-1">
                        {benchmark.category}
                      </span>
                      <span className="max-w-[46ch] text-[15px] leading-snug text-[#111318] underline decoration-transparent underline-offset-4 transition-colors group-hover:decoration-black/30">
