  ...
  return (
    <section id="impact" className="scroll-mt-24 bg-ink-deep text-white">
      <div className="mx-auto max-w-[92rem] px-5 py-16 sm:px-8 sm:py-24 lg:px-10 lg:py-28">
        <Reveal>
          <div className="grid gap-10 lg:grid-cols-[minmax(15rem,0.46fr)_minmax(0,1.54fr)] lg:items-center lg:gap-16">
            <div>
              ...
              <p className="mt-5 max-w-[34ch] text-[15px] leading-[1.7] text-white/66">
